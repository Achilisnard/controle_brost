...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLK_OUT1_PORT {clk_74} \
   CONFIG.CLK_OUT2_PORT {clk_148} \
  ...
  # Create instance: hsize, and set properties
  set hsize [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 hsize ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {1920} \
   CONFIG.CONST_WIDTH {32} \
 ] $hsize

  # Create instance: incrust_0, and set properties
  set incrust_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:incrust:1.1 incrust_0 ]
  ...
  # Create instance: start_x, and set properties
  set start_x [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 start_x ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {100} \
   CONFIG.CONST_WIDTH {32} \
 ] $start_x

  # Create instance: start_y, and set properties
  set start_y [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 start_y ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {300} \
   CONFIG.CONST_WIDTH {32} \
 ] $start_y
  ...
  # Create instance: vsize, and set properties
  set vsize [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 vsize ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {1080} \
   CONFIG.CONST_WIDTH {32} \
 ] $vsize
  ...
  connect_bd_intf_net -intf_net axi_vdma_a_M_AXIS_MM2S [get_bd_intf_pins axi_vdma_a/M_AXIS_MM2S] [get_bd_intf_pins incrust_0/s_axis_video]
  ...
  connect_bd_intf_net -intf_net incrust_0_m_axis_video [get_bd_intf_pins incrust_0/m_axis_video] [get_bd_intf_pins v_axi4s_vid_out_0/video_in]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_vdma_b/S_AXI_LITE] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins AXI_GammaCorrection_B/AXI_Lite_Reg_Intf] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins axi_cama_bta/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M08_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M09_AXI [get_bd_intf_pins axi_cama_gpio/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M09_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M11_AXI [get_bd_intf_pins ps7_0_axi_periph/M11_AXI] [get_bd_intf_pins video_scaler_b/s_axi_ctrl]
  ...
  connect_bd_intf_net -intf_net video_scaler_a_stream_out [get_bd_intf_pins axi_vdma_a/S_AXIS_S2MM] [get_bd_intf_pins video_scaler_a/stream_out]
  ...
  connect_bd_net -net MIPI_D_PHY_RX_0_rDlyCtrlLockedOut [get_bd_pins MIPI_D_PHY_RX_A/rDlyCtrlLockedOut] [get_bd_pins MIPI_D_PHY_RX_B/rDlyCtrlLockedIn]
  ...
  connect_bd_net -net clk_wiz_1_clk_74 [get_bd_pins clk_wiz_1/clk_74] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins rgb2vga_0/PixelClk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
  ...
  connect_bd_net -net hsize_dout [get_bd_pins hsize/dout] [get_bd_pins incrust_0/hsize_in]
  connect_bd_net -net mm_clk_150 [get_bd_pins AXI_BayerToRGB_A/StreamClk] [get_bd_pins AXI_BayerToRGB_B/StreamClk] [get_bd_pins AXI_GammaCorrection_A/StreamClk] [get_bd_pins AXI_GammaCorrection_B/StreamClk] [get_bd_pins MIPI_CSI_2_RX_A/video_aclk] [get_bd_pins MIPI_CSI_2_RX_B/video_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_mem_intercon_1/S01_ACLK] [get_bd_pins axi_vdma_a/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_a/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_a/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_a/s_axis_s2mm_aclk] [get_bd_pins axi_vdma_b/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_b/s_axis_s2mm_aclk] [get_bd_pins clk_wiz_0/clk_150] [get_bd_pins incrust_0/ap_clk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/M11_ACLK] [get_bd_pins rst_system_150M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk] [get_bd_pins video_scaler_a/ap_clk] [get_bd_pins video_scaler_b/ap_clk]
  ...
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_clk_wiz_0_50M/ext_reset_in] [get_bd_pins rst_system_150M/ext_reset_in]
  connect_bd_net -net ref_clk_200 [get_bd_pins MIPI_D_PHY_RX_A/RefClk] [get_bd_pins MIPI_D_PHY_RX_B/RefClk] [get_bd_pins clk_wiz_0/clk_200]
  ...
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_aresetn [get_bd_pins AXI_BayerToRGB_A/sStreamReset_n] [get_bd_pins AXI_BayerToRGB_B/sStreamReset_n] [get_bd_pins AXI_GammaCorrection_A/aAxiLiteReset_n] [get_bd_pins AXI_GammaCorrection_A/sStreamReset_n] [get_bd_pins AXI_GammaCorrection_B/aAxiLiteReset_n] [get_bd_pins AXI_GammaCorrection_B/sStreamReset_n] [get_bd_pins MIPI_CSI_2_RX_A/s_axi_lite_aresetn] [get_bd_pins MIPI_CSI_2_RX_B/s_axi_lite_aresetn] [get_bd_pins MIPI_D_PHY_RX_A/s_axi_lite_aresetn] [get_bd_pins MIPI_D_PHY_RX_B/s_axi_lite_aresetn] [get_bd_pins axi_cama_bta/s_axi_aresetn] [get_bd_pins axi_cama_gpio/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/S01_ARESETN] [get_bd_pins axi_vdma_a/axi_resetn] [get_bd_pins axi_vdma_b/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M07_ARESETN] [get_bd_pins ps7_0_axi_periph/M08_ARESETN] [get_bd_pins ps7_0_axi_periph/M09_ARESETN] [get_bd_pins ps7_0_axi_periph/M10_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_50M/peripheral_aresetn] [get_bd_pins video_scaler_a/ap_rst_n] [get_bd_pins video_scaler_b/ap_rst_n]
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_reset [get_bd_pins MIPI_D_PHY_RX_A/aRst] [get_bd_pins MIPI_D_PHY_RX_B/aRst] [get_bd_pins rst_clk_wiz_0_50M/peripheral_reset]
  connect_bd_net -net rst_system_150M_peripheral_aresetn [get_bd_pins incrust_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/M11_ARESETN] [get_bd_pins rst_system_150M/peripheral_aresetn]
  connect_bd_net -net s_axil_clk_50 [get_bd_pins AXI_GammaCorrection_A/AxiLiteClk] [get_bd_pins AXI_GammaCorrection_B/AxiLiteClk] [get_bd_pins MIPI_CSI_2_RX_A/s_axi_lite_aclk] [get_bd_pins MIPI_CSI_2_RX_B/s_axi_lite_aclk] [get_bd_pins MIPI_D_PHY_RX_A/s_axi_lite_aclk] [get_bd_pins MIPI_D_PHY_RX_B/s_axi_lite_aclk] [get_bd_pins axi_cama_bta/s_axi_aclk] [get_bd_pins axi_cama_gpio/s_axi_aclk] [get_bd_pins axi_vdma_a/s_axi_lite_aclk] [get_bd_pins axi_vdma_b/s_axi_lite_aclk] [get_bd_pins clk_wiz_0/clk_50] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M07_ACLK] [get_bd_pins ps7_0_axi_periph/M08_ACLK] [get_bd_pins ps7_0_axi_periph/M09_ACLK] [get_bd_pins ps7_0_axi_periph/M10_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_0_50M/slowest_sync_clk]
  connect_bd_net -net start_x_dout [get_bd_pins incrust_0/start_x] [get_bd_pins start_x/dout]
  connect_bd_net -net start_y_dout [get_bd_pins incrust_0/start_y] [get_bd_pins start_y/dout]
  ...
  connect_bd_net -net vsize_dout [get_bd_pins incrust_0/vsize_in] [get_bd_pins vsize/dout]
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins clk_wiz_1/reset] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xlconstant_0/dout]
  ...
  assign_bd_address -offset 0x43C40000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_GammaCorrection_A/AXI_Lite_Reg_Intf/Reg] -force
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_GammaCorrection_B/AXI_Lite_Reg_Intf/Reg] -force
  assign_bd_address -offset 0x43C30000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_CSI_2_RX_A/S_AXI_LITE/S_AXI_LITE_reg] -force
  assign_bd_address -offset 0x43D80000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_CSI_2_RX_B/S_AXI_LITE/S_AXI_LITE_reg] -force
  assign_bd_address -offset 0x43C20000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_D_PHY_RX_A/S_AXI_LITE/S_AXI_LITE_reg] -force
  assign_bd_address -offset 0x43DB0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_D_PHY_RX_B/S_AXI_LITE/S_AXI_LITE_reg] -force
  ...
  assign_bd_address -offset 0x43C80000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video_scaler_a/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video_scaler_b/s_axi_ctrl/Reg] -force
