...
HD_PWD='F:/vivado_proj/Pcam_Adapter_base/Pcam_Adapter_base.runs/system_incrust_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_incrust_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_incrust_0_0.tcl
