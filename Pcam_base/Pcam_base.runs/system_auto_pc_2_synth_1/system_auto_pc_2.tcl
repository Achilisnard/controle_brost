...
read_ip -quiet f:/PFE/Pcam_base/Pcam_base.srcs/sources_1/bd/system/ip/system_auto_pc_2/system_auto_pc_2.xci
...
set cached_ip [config_ip_cache -export -no_bom  -dir F:/PFE/Pcam_base/Pcam_base.runs/system_auto_pc_2_synth_1 -new_name system_auto_pc_2 -ip [get_ips system_auto_pc_2]]
...
if { [catch {
  file copy -force F:/PFE/Pcam_base/Pcam_base.runs/system_auto_pc_2_synth_1/system_auto_pc_2.dcp f:/PFE/Pcam_base/Pcam_base.srcs/sources_1/bd/system/ip/system_auto_pc_2/system_auto_pc_2.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub f:/PFE/Pcam_base/Pcam_base.srcs/sources_1/bd/system/ip/system_auto_pc_2/system_auto_pc_2_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub f:/PFE/Pcam_base/Pcam_base.srcs/sources_1/bd/system/ip/system_auto_pc_2/system_auto_pc_2_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim f:/PFE/Pcam_base/Pcam_base.srcs/sources_1/bd/system/ip/system_auto_pc_2/system_auto_pc_2_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim f:/PFE/Pcam_base/Pcam_base.srcs/sources_1/bd/system/ip/system_auto_pc_2/system_auto_pc_2_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force F:/PFE/Pcam_base/Pcam_base.runs/system_auto_pc_2_synth_1/system_auto_pc_2_stub.v f:/PFE/Pcam_base/Pcam_base.srcs/sources_1/bd/system/ip/system_auto_pc_2/system_auto_pc_2_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force F:/PFE/Pcam_base/Pcam_base.runs/system_auto_pc_2_synth_1/system_auto_pc_2_stub.vhdl f:/PFE/Pcam_base/Pcam_base.srcs/sources_1/bd/system/ip/system_auto_pc_2/system_auto_pc_2_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force F:/PFE/Pcam_base/Pcam_base.runs/system_auto_pc_2_synth_1/system_auto_pc_2_sim_netlist.v f:/PFE/Pcam_base/Pcam_base.srcs/sources_1/bd/system/ip/system_auto_pc_2/system_auto_pc_2_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force F:/PFE/Pcam_base/Pcam_base.runs/system_auto_pc_2_synth_1/system_auto_pc_2_sim_netlist.vhdl f:/PFE/Pcam_base/Pcam_base.srcs/sources_1/bd/system/ip/system_auto_pc_2/system_auto_pc_2_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir F:/PFE/Pcam_base/Pcam_base.ip_user_files/ip/system_auto_pc_2]} {
  catch { 
    file copy -force f:/PFE/Pcam_base/Pcam_base.srcs/sources_1/bd/system/ip/system_auto_pc_2/system_auto_pc_2_stub.v F:/PFE/Pcam_base/Pcam_base.ip_user_files/ip/system_auto_pc_2
  }
}

if {[file isdir F:/PFE/Pcam_base/Pcam_base.ip_user_files/ip/system_auto_pc_2]} {
  catch { 
    file copy -force f:/PFE/Pcam_base/Pcam_base.srcs/sources_1/bd/system/ip/system_auto_pc_2/system_auto_pc_2_stub.vhdl F:/PFE/Pcam_base/Pcam_base.ip_user_files/ip/system_auto_pc_2
  }
}
