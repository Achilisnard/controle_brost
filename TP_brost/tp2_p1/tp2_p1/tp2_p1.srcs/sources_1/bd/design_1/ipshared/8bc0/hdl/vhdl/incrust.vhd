...
architecture behav of incrust is 
    ...
    "incrust,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.918000,HLS_SYN_LAT=922561,HLS_SYN_TPT=none,HLS_SYN_MEM=8,HLS_SYN_DSP=0,HLS_SYN_FF=311,HLS_SYN_LUT=540,HLS_VERSION=2019_2}";
    ...
    signal start_y_read_reg_354 : STD_LOGIC_VECTOR (31 downto 0);
    signal start_x_read_reg_359 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln25_fu_180_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln25_reg_364 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln25_1_fu_186_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln25_1_reg_369 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_207_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_reg_377 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal regslice_both_m_axis_video_V_data_V_U_apdone_blk : STD_LOGIC;
    signal and_ln25_1_fu_229_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln25_1_reg_382 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln20_fu_201_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_fu_245_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal j_reg_390 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal and_ln25_2_fu_276_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln25_2_reg_395 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln22_fu_239_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_0_reg_158 : STD_LOGIC_VECTOR (8 downto 0);
    signal j_0_reg_169 : STD_LOGIC_VECTOR (9 downto 0);
    signal sext_ln26_fu_281_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal pixel_1_fu_86 : STD_LOGIC_VECTOR (31 downto 0);
    signal pixel_2_fu_292_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln20_fu_197_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln25_fu_213_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln25_fu_218_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln25_1_fu_224_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln22_fu_235_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln25_2_fu_254_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln25_1_fu_259_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln25_3_fu_265_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln25_fu_270_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sext_ln26_fu_281_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal pixel_fu_286_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal pixel_fu_286_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal pixel_2_fu_292_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln22_fu_239_p2 = ap_const_lv1_1))) then 
                i_0_reg_158 <= i_reg_377;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
                i_0_reg_158 <= ap_const_lv9_0;
            end if; 
        end if;
    end process;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln20_fu_201_p2 = ap_const_lv1_0) and (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_0))) then 
                j_0_reg_169 <= ap_const_lv10_0;
            elsif (((m_axis_video_TREADY_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
                j_0_reg_169 <= j_reg_390;
            end if; 
        end if;
    end process;

    pixel_1_fu_86_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln22_fu_239_p2 = ap_const_lv1_0))) then 
                pixel_1_fu_86 <= pixel_2_fu_292_p3;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
                pixel_1_fu_86 <= ap_const_lv32_0;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                add_ln25_1_reg_369 <= add_ln25_1_fu_186_p2;
                add_ln25_reg_364 <= add_ln25_fu_180_p2;
                start_x_read_reg_359 <= start_x;
                start_y_read_reg_354 <= start_y;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln20_fu_201_p2 = ap_const_lv1_0) and (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_0))) then
                and_ln25_1_reg_382 <= and_ln25_1_fu_229_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln22_fu_239_p2 = ap_const_lv1_0))) then
                and_ln25_2_reg_395 <= and_ln25_2_fu_276_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                j_reg_390 <= j_fu_245_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state2, regslice_both_m_axis_video_V_data_V_U_apdone_blk, icmp_ln20_fu_201_p2, ap_CS_fsm_state3, icmp_ln22_fu_239_p2, s_axis_video_TVALID_int, m_axis_video_TREADY_int)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln20_fu_201_p2 = ap_const_lv1_1) and (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_0))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln20_fu_201_p2 = ap_const_lv1_0) and (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_0))) then
    ...
    add_ln25_1_fu_186_p2 <= std_logic_vector(unsigned(start_y) + unsigned(ap_const_lv32_45));
    add_ln25_fu_180_p2 <= std_logic_vector(unsigned(start_x) + unsigned(ap_const_lv32_94));
    and_ln25_1_fu_229_p2 <= (xor_ln25_fu_218_p2 and icmp_ln25_1_fu_224_p2);
    and_ln25_2_fu_276_p2 <= (and_ln25_fu_270_p2 and and_ln25_1_reg_382);
    and_ln25_fu_270_p2 <= (xor_ln25_1_fu_259_p2 and icmp_ln25_3_fu_265_p2);
    ...
    ap_done_assign_proc : process(ap_CS_fsm_state2, regslice_both_m_axis_video_V_data_V_U_apdone_blk, icmp_ln20_fu_201_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln20_fu_201_p2 = ap_const_lv1_1) and (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_0))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, regslice_both_m_axis_video_V_data_V_U_apdone_blk, icmp_ln20_fu_201_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln20_fu_201_p2 = ap_const_lv1_1) and (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_0))) then 
    ...
    i_fu_207_p2 <= std_logic_vector(unsigned(i_0_reg_158) + unsigned(ap_const_lv9_1));
    icmp_ln20_fu_201_p2 <= "1" when (i_0_reg_158 = ap_const_lv9_1E0) else "0";
    icmp_ln22_fu_239_p2 <= "1" when (j_0_reg_169 = ap_const_lv10_280) else "0";
    icmp_ln25_1_fu_224_p2 <= "1" when (signed(zext_ln20_fu_197_p1) < signed(add_ln25_1_reg_369)) else "0";
    icmp_ln25_2_fu_254_p2 <= "1" when (signed(zext_ln22_fu_235_p1) < signed(start_x_read_reg_359)) else "0";
    icmp_ln25_3_fu_265_p2 <= "1" when (signed(zext_ln22_fu_235_p1) < signed(add_ln25_reg_364)) else "0";
    icmp_ln25_fu_213_p2 <= "1" when (signed(zext_ln20_fu_197_p1) < signed(start_y_read_reg_354)) else "0";
    im_incrust_V_address0 <= sext_ln26_fu_281_p1(14 - 1 downto 0);
    ...
    j_fu_245_p2 <= std_logic_vector(unsigned(j_0_reg_169) + unsigned(ap_const_lv10_1));
    ...
    m_axis_video_TDATA_int <= 
        im_incrust_V_q0 when (and_ln25_2_reg_395(0) = '1') else 
    ...
    pixel_2_fu_292_p2 <= pixel_1_fu_86;
    pixel_2_fu_292_p3 <= 
        pixel_fu_286_p2 when (and_ln25_2_fu_276_p2(0) = '1') else 
        pixel_2_fu_292_p2;
    pixel_fu_286_p0 <= pixel_1_fu_86;
    pixel_fu_286_p2 <= std_logic_vector(signed(pixel_fu_286_p0) + signed(ap_const_lv32_1));
    ...
    sext_ln26_fu_281_p0 <= pixel_1_fu_86;
        sext_ln26_fu_281_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln26_fu_281_p0),64));

    xor_ln25_1_fu_259_p2 <= (icmp_ln25_2_fu_254_p2 xor ap_const_lv1_1);
    xor_ln25_fu_218_p2 <= (icmp_ln25_fu_213_p2 xor ap_const_lv1_1);
    zext_ln20_fu_197_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_158),32));
    zext_ln22_fu_235_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_0_reg_169),32));
end behav;
