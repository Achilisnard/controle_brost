...
proc create_root_design { parentCell } {
  ...
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:incrust:1.1 hls_inst ]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces s_axi_AXILiteS] [get_bd_addr_segs hls_inst/s_axi_AXILiteS/Reg] -force
