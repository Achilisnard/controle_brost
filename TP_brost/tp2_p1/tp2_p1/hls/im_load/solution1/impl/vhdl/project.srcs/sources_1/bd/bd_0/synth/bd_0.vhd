...
architecture STRUCTURE of bd_0 is
  ...
  signal hls_inst_mem_V_address0 : STD_LOGIC_VECTOR ( 18 downto 0 );
  signal hls_inst_mem_V_ce0 : STD_LOGIC;
  signal mem_V_q0_0_1 : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute X_INTERFACE_INFO of mem_V_address0 : signal is "xilinx.com:signal:data:1.0 DATA.MEM_V_ADDRESS0 DATA";
  attribute X_INTERFACE_PARAMETER of mem_V_address0 : signal is "XIL_INTERFACENAME DATA.MEM_V_ADDRESS0, LAYERED_METADATA undef";
  attribute X_INTERFACE_INFO of mem_V_q0 : signal is "xilinx.com:signal:data:1.0 DATA.MEM_V_Q0 DATA";
  attribute X_INTERFACE_PARAMETER of mem_V_q0 : signal is "XIL_INTERFACENAME DATA.MEM_V_Q0, LAYERED_METADATA undef";
...
begin
  ...
  mem_V_address0(18 downto 0) <= hls_inst_mem_V_address0(18 downto 0);
  mem_V_ce0 <= hls_inst_mem_V_ce0;
  mem_V_q0_0_1(7 downto 0) <= mem_V_q0(7 downto 0);
...
hls_inst: component bd_0_hls_inst_0
     port map (
      ...
      mem_V_address0(18 downto 0) => hls_inst_mem_V_address0(18 downto 0),
      mem_V_ce0 => hls_inst_mem_V_ce0,
      mem_V_q0(7 downto 0) => mem_V_q0_0_1(7 downto 0),
