...
architecture behav of incust_bar is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "incust_bar,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.918000,HLS_SYN_LAT=922561,HLS_SYN_TPT=none,HLS_SYN_MEM=1,HLS_SYN_DSP=0,HLS_SYN_FF=311,HLS_SYN_LUT=542,HLS_VERSION=2019_2}";
    ...
    signal im_incrust_V_address0 : STD_LOGIC_VECTOR (10 downto 0);
    signal im_incrust_V_ce0 : STD_LOGIC;
    signal im_incrust_V_q0 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal start_y_read_reg_366 : STD_LOGIC_VECTOR (31 downto 0);
    signal start_x_read_reg_371 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln24_fu_184_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln24_reg_376 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln24_1_fu_190_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln24_1_reg_381 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_211_p2 : STD_LOGIC_VECTOR (8 downto 0);
    signal i_reg_389 : STD_LOGIC_VECTOR (8 downto 0);
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal regslice_both_m_axis_video_V_data_V_U_apdone_blk : STD_LOGIC;
    signal and_ln24_1_fu_233_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln24_1_reg_394 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln19_fu_205_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal j_fu_249_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal j_reg_402 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal and_ln24_2_fu_280_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln24_2_reg_407 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln21_fu_243_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal i_0_reg_162 : STD_LOGIC_VECTOR (8 downto 0);
    signal j_0_reg_173 : STD_LOGIC_VECTOR (9 downto 0);
    signal sext_ln25_fu_285_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal pixel_1_fu_90 : STD_LOGIC_VECTOR (31 downto 0);
    signal pixel_2_fu_296_p3 : STD_LOGIC_VECTOR (31 downto 0);
    signal zext_ln19_fu_201_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln24_fu_217_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln24_fu_222_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln24_1_fu_228_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal zext_ln21_fu_239_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal icmp_ln24_2_fu_258_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln24_1_fu_263_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln24_3_fu_269_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal and_ln24_fu_274_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal sext_ln25_fu_285_p0 : STD_LOGIC_VECTOR (31 downto 0);
    signal pixel_fu_290_p1 : STD_LOGIC_VECTOR (31 downto 0);
    signal pixel_fu_290_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal pixel_2_fu_296_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal select_ln321_fu_343_p3 : STD_LOGIC_VECTOR (7 downto 0);
    ...
    component incust_bar_im_incbkb IS
    generic (
        DataWidth : INTEGER;
    ...
    component incust_bar_AXILiteS_s_axi IS
    generic (
...
begin
    im_incrust_V_U : component incust_bar_im_incbkb
    generic map (
        DataWidth => 1,
        AddressRange => 1480,
        AddressWidth => 11)
    ...
    incust_bar_AXILiteS_s_axi_U : component incust_bar_AXILiteS_s_axi
    generic map (
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln21_fu_243_p2 = ap_const_lv1_1))) then 
                i_0_reg_162 <= i_reg_389;
    ...
    j_0_reg_173_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln19_fu_205_p2 = ap_const_lv1_0) and (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_0))) then 
                j_0_reg_173 <= ap_const_lv10_0;
            elsif (((m_axis_video_TREADY_int = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state5))) then 
                j_0_reg_173 <= j_reg_402;
            end if; 
        end if;
    end process;

    pixel_1_fu_90_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln21_fu_243_p2 = ap_const_lv1_0))) then 
                pixel_1_fu_90 <= pixel_2_fu_296_p3;
            elsif (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                add_ln24_1_reg_381 <= add_ln24_1_fu_190_p2;
                add_ln24_reg_376 <= add_ln24_fu_184_p2;
                start_x_read_reg_371 <= start_x;
                start_y_read_reg_366 <= start_y;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln19_fu_205_p2 = ap_const_lv1_0) and (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_0))) then
                and_ln24_1_reg_394 <= and_ln24_1_fu_233_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state3) and (icmp_ln21_fu_243_p2 = ap_const_lv1_0))) then
                and_ln24_2_reg_407 <= and_ln24_2_fu_280_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                j_reg_402 <= j_fu_249_p2;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state4, ap_CS_fsm_state5, ap_CS_fsm_state2, regslice_both_m_axis_video_V_data_V_U_apdone_blk, icmp_ln19_fu_205_p2, ap_CS_fsm_state3, icmp_ln21_fu_243_p2, s_axis_video_TVALID_int, m_axis_video_TREADY_int)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln19_fu_205_p2 = ap_const_lv1_1) and (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_0))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln19_fu_205_p2 = ap_const_lv1_0) and (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_0))) then
    ...
    add_ln24_1_fu_190_p2 <= std_logic_vector(unsigned(start_y) + unsigned(ap_const_lv32_A));
    add_ln24_fu_184_p2 <= std_logic_vector(unsigned(start_x) + unsigned(ap_const_lv32_94));
    and_ln24_1_fu_233_p2 <= (xor_ln24_fu_222_p2 and icmp_ln24_1_fu_228_p2);
    and_ln24_2_fu_280_p2 <= (and_ln24_fu_274_p2 and and_ln24_1_reg_394);
    and_ln24_fu_274_p2 <= (xor_ln24_1_fu_263_p2 and icmp_ln24_3_fu_269_p2);
    ...
    ap_done_assign_proc : process(ap_CS_fsm_state2, regslice_both_m_axis_video_V_data_V_U_apdone_blk, icmp_ln19_fu_205_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln19_fu_205_p2 = ap_const_lv1_1) and (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_0))) then 
    ...
    ap_ready_assign_proc : process(ap_CS_fsm_state2, regslice_both_m_axis_video_V_data_V_U_apdone_blk, icmp_ln19_fu_205_p2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) and (icmp_ln19_fu_205_p2 = ap_const_lv1_1) and (regslice_both_m_axis_video_V_data_V_U_apdone_blk = ap_const_logic_0))) then 
    ...
    i_fu_211_p2 <= std_logic_vector(unsigned(i_0_reg_162) + unsigned(ap_const_lv9_1));
    icmp_ln19_fu_205_p2 <= "1" when (i_0_reg_162 = ap_const_lv9_1E0) else "0";
    icmp_ln21_fu_243_p2 <= "1" when (j_0_reg_173 = ap_const_lv10_280) else "0";
    icmp_ln24_1_fu_228_p2 <= "1" when (signed(zext_ln19_fu_201_p1) < signed(add_ln24_1_reg_381)) else "0";
    icmp_ln24_2_fu_258_p2 <= "1" when (signed(zext_ln21_fu_239_p1) < signed(start_x_read_reg_371)) else "0";
    icmp_ln24_3_fu_269_p2 <= "1" when (signed(zext_ln21_fu_239_p1) < signed(add_ln24_reg_376)) else "0";
    icmp_ln24_fu_217_p2 <= "1" when (signed(zext_ln19_fu_201_p1) < signed(start_y_read_reg_366)) else "0";
    im_incrust_V_address0 <= sext_ln25_fu_285_p1(11 - 1 downto 0);
    ...
    j_fu_249_p2 <= std_logic_vector(unsigned(j_0_reg_173) + unsigned(ap_const_lv10_1));
    ...
    m_axis_video_TDATA_int <= 
        select_ln321_fu_343_p3 when (and_ln24_2_reg_407(0) = '1') else 
    ...
    pixel_2_fu_296_p2 <= pixel_1_fu_90;
    pixel_2_fu_296_p3 <= 
        pixel_fu_290_p2 when (and_ln24_2_fu_280_p2(0) = '1') else 
        pixel_2_fu_296_p2;
    pixel_fu_290_p1 <= pixel_1_fu_90;
    pixel_fu_290_p2 <= std_logic_vector(unsigned(ap_const_lv32_1) + unsigned(pixel_fu_290_p1));
    ...
    select_ln321_fu_343_p3 <= 
        ap_const_lv8_FF when (im_incrust_V_q0(0) = '1') else 
        ap_const_lv8_0;
    sext_ln25_fu_285_p0 <= pixel_1_fu_90;
        sext_ln25_fu_285_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(sext_ln25_fu_285_p0),64));

    xor_ln24_1_fu_263_p2 <= (icmp_ln24_2_fu_258_p2 xor ap_const_lv1_1);
    xor_ln24_fu_222_p2 <= (icmp_ln24_fu_217_p2 xor ap_const_lv1_1);
    zext_ln19_fu_201_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(i_0_reg_162),32));
    zext_ln21_fu_239_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(j_0_reg_173),32));
end behav;
