...
set Library     "hls"
set IPName      "incust_bar"
set Version     "1.0"
set DisplayName "Incust_bar"
set Revision    "0"
...
set sdx_kernel_name "incust_bar"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "C:/Users/achil/OneDrive/Documents/5A/brost/TP_brost/tp2_p2/tp2_p2/hls/incust_bar/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {incust_bar_im_incbkb
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 start_x W 0x0 "Data signal of start_x" {{0 32 start_x W 0 "Bit 31 to 0 Data signal of start_x"}}} {0x18 start_y W 0x0 "Data signal of start_y" {{0 32 start_y W 0 "Bit 31 to 0 Data signal of start_y"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS s_axis_video m_axis_video"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 922561 II x}
