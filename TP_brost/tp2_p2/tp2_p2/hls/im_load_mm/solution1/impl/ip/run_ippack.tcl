...
set Library     "hls"
set IPName      "im_load_mm"
set Version     "1.1"
set DisplayName "Im_load_mm"
set Revision    "1"
...
set sdx_kernel_name "im_load_mm"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "C:/Users/ai770741/Documents/TP_Brost/tp2_p2/tp2_p2/hls/im_load_mm/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {im_load_mm_mem_lobkb
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 mem_ddr_V W 0x0 "Data signal of mem_ddr_V" {{0 32 mem_ddr_V W 0 "Bit 31 to 0 Data signal of mem_ddr_V"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_gmem m_axis_video"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 1234561 II x}
