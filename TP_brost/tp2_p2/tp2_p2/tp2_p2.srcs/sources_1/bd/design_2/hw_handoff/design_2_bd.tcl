...
proc create_hier_cell_video_ctrl { parentCell nameHier } {
  ...
  connect_bd_net -net clk_wiz_0_clk_25 [get_bd_pins rd_clk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/vid_io_out_clk] [get_bd_pins v_tc_0/clk]
  ...
  connect_bd_net -net v_axi4s_vid_out_0_vid_data [get_bd_pins v_axi4s_vid_out_0/vid_data] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net wr_clk_1 [get_bd_pins wr_clk] [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins vid_data] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_1/ext_reset_in] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_1_dout1 [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins v_tc_0/resetn]
...
proc create_root_design { parentCell } {
  ...
  set down_button_0 [ create_bd_port -dir I down_button_0 ]
  set left_button_0 [ create_bd_port -dir I left_button_0 ]
  set right_button_0 [ create_bd_port -dir I right_button_0 ]
  set sioc [ create_bd_port -dir O sioc ]
  set siod [ create_bd_port -dir IO siod ]
  set up_button_0 [ create_bd_port -dir I up_button_0 ]
  ...
  # Create instance: im_load_mm_0, and set properties
  set im_load_mm_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:im_load_mm:1.1 im_load_mm_0 ]
  ...
  # Create instance: incrust_1, and set properties
  set incrust_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:incrust:1.1 incrust_1 ]

  # Create instance: incust_bar_0, and set properties
  set incust_bar_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:incust_bar:1.0 incust_bar_0 ]
  ...
  # Create instance: switch_value_0, and set properties
  set switch_value_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:switch_value:1.0 switch_value_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net im_load_mm_0_m_axi_gmem [get_bd_intf_pins im_load_mm_0/m_axi_gmem] [get_bd_intf_pins smartconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net im_load_mm_0_m_axis_video [get_bd_intf_pins im_load_mm_0/m_axis_video] [get_bd_intf_pins incrust_0/s_axis_video]
  connect_bd_intf_net -intf_net incrust_0_m_axis_video [get_bd_intf_pins incrust_0/m_axis_video] [get_bd_intf_pins incrust_1/s_axis_video]
  connect_bd_intf_net -intf_net incrust_1_m_axis_video [get_bd_intf_pins incrust_1/m_axis_video] [get_bd_intf_pins incust_bar_0/s_axis_video]
  connect_bd_intf_net -intf_net incust_bar_0_m_axis_video [get_bd_intf_pins incust_bar_0/m_axis_video] [get_bd_intf_pins video_ctrl/video_in]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins processing_system7_0/S_AXI_HP0] [get_bd_intf_pins smartconnect_0/M01_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins incrust_0/s_axi_AXILiteS] [get_bd_intf_pins smartconnect_0/M02_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins im_load_mm_0/s_axi_AXILiteS] [get_bd_intf_pins smartconnect_0/M03_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M04_AXI [get_bd_intf_pins smartconnect_0/M04_AXI] [get_bd_intf_pins switch_value_0/S00_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M05_AXI [get_bd_intf_pins incust_bar_0/s_axi_AXILiteS] [get_bd_intf_pins smartconnect_0/M05_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M06_AXI [get_bd_intf_pins incrust_1/s_axi_AXILiteS] [get_bd_intf_pins smartconnect_0/M06_AXI]

  # Create port connections
  connect_bd_net -net Net [get_bd_ports siod] [get_bd_pins video_ctrl/siod]
  ...
  connect_bd_net -net clk_wiz_0_clk_50 [get_bd_pins clk_wiz_0/clk_50] [get_bd_pins video_ctrl/clk]
  connect_bd_net -net clk_wiz_0_clk_100 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_100] [get_bd_pins im_load_mm_0/ap_clk] [get_bd_pins incrust_0/ap_clk] [get_bd_pins incrust_1/ap_clk] [get_bd_pins incust_bar_0/ap_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins smartconnect_0/aclk] [get_bd_pins switch_value_0/s00_axi_aclk] [get_bd_pins video_ctrl/wr_clk]
  connect_bd_net -net down_button_0_1 [get_bd_ports down_button_0] [get_bd_pins switch_value_0/down_button]
  connect_bd_net -net i_0_1 [get_bd_ports btn] [get_bd_pins video_ctrl/btn]
  connect_bd_net -net left_button_0_1 [get_bd_ports left_button_0] [get_bd_pins switch_value_0/left_button]
  connect_bd_net -net right_button_0_1 [get_bd_ports right_button_0] [get_bd_pins switch_value_0/right_button]
  connect_bd_net -net up_button_0_1 [get_bd_ports up_button_0] [get_bd_pins switch_value_0/up_button]
  ...
  connect_bd_net -net video_ctrl_dout [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins im_load_mm_0/ap_rst_n] [get_bd_pins incrust_0/ap_rst_n] [get_bd_pins incrust_1/ap_rst_n] [get_bd_pins incust_bar_0/ap_rst_n] [get_bd_pins smartconnect_0/aresetn] [get_bd_pins switch_value_0/s00_axi_aresetn] [get_bd_pins video_ctrl/peripheral_aresetn]
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins im_load_mm_0/ap_start] [get_bd_pins incrust_0/ap_start] [get_bd_pins incrust_1/ap_start] [get_bd_pins incust_bar_0/ap_start] [get_bd_pins xlconstant_2/dout]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00080000 -target_address_space [get_bd_addr_spaces im_load_mm_0/Data_m_axi_gmem] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
  ...
  assign_bd_address -offset 0x400A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces im_load_mm_0/Data_m_axi_gmem] [get_bd_addr_segs incrust_1/s_axi_AXILiteS/Reg] -force
  assign_bd_address -offset 0x40090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces im_load_mm_0/Data_m_axi_gmem] [get_bd_addr_segs incust_bar_0/s_axi_AXILiteS/Reg] -force
  assign_bd_address -offset 0x40080000 -range 0x00001000 -target_address_space [get_bd_addr_spaces im_load_mm_0/Data_m_axi_gmem] [get_bd_addr_segs switch_value_0/S00_AXI/S00_AXI_reg] -force
  ...
  assign_bd_address -offset 0x400A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs incrust_1/s_axi_AXILiteS/Reg] -force
  assign_bd_address -offset 0x40090000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs incust_bar_0/s_axi_AXILiteS/Reg] -force
  assign_bd_address -offset 0x40080000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs switch_value_0/S00_AXI/S00_AXI_reg] -force
