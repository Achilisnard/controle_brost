...
wire   [0:0] icmp_ln24_fu_125_p2;
wire   [0:0] xor_ln19_fu_131_p2;
wire   [0:0] icmp_ln19_fu_119_p2;
wire   [0:0] xor_ln19_1_fu_146_p2;
...
assign and_ln19_fu_152_p2 = (xor_ln19_1_fu_146_p2 & icmp_ln24_fu_125_p2);
...
assign icmp_ln19_fu_119_p2 = ((x_0_reg_84 < 10'd213) ? 1'b1 : 1'b0);

assign icmp_ln24_fu_125_p2 = ((x_0_reg_84 < 10'd427) ? 1'b1 : 1'b0);

assign p_blue_ap_vld = regslice_forward_p_blue_U_vld_out;

assign p_blue_int = ((xor_ln19_fu_131_p2[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign p_green_ap_vld = regslice_forward_p_green_U_vld_out;

assign p_green_int = ((and_ln19_fu_152_p2[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign p_red_ap_vld = regslice_forward_p_red_U_vld_out;

assign p_red_int = ((icmp_ln19_fu_119_p2[0:0] === 1'b1) ? 8'd255 : 8'd0);

assign x_fu_113_p2 = (x_0_reg_84 + 10'd1);

assign xor_ln19_1_fu_146_p2 = (icmp_ln19_fu_119_p2 ^ 1'd1);

assign xor_ln19_fu_131_p2 = (icmp_ln24_fu_125_p2 ^ 1'd1);
