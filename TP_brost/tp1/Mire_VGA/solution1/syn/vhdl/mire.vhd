...
architecture behav of mire is 
    ...
    signal icmp_ln24_fu_125_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln19_fu_131_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln19_fu_119_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal xor_ln19_1_fu_146_p2 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    and_ln19_fu_152_p2 <= (xor_ln19_1_fu_146_p2 and icmp_ln24_fu_125_p2);
    ...
    icmp_ln19_fu_119_p2 <= "1" when (unsigned(x_0_reg_84) < unsigned(ap_const_lv10_D5)) else "0";
    icmp_ln24_fu_125_p2 <= "1" when (unsigned(x_0_reg_84) < unsigned(ap_const_lv10_1AB)) else "0";
    ...
    p_blue_int <= 
        ap_const_lv8_FF when (xor_ln19_fu_131_p2(0) = '1') else 
        ap_const_lv8_0;
    ...
    p_green_int <= 
        ap_const_lv8_FF when (and_ln19_fu_152_p2(0) = '1') else 
        ap_const_lv8_0;
    ...
    p_red_int <= 
        ap_const_lv8_FF when (icmp_ln19_fu_119_p2(0) = '1') else 
        ap_const_lv8_0;
    x_fu_113_p2 <= std_logic_vector(unsigned(x_0_reg_84) + unsigned(ap_const_lv10_1));
    xor_ln19_1_fu_146_p2 <= (icmp_ln19_fu_119_p2 xor ap_const_lv1_1);
    xor_ln19_fu_131_p2 <= (icmp_ln24_fu_125_p2 xor ap_const_lv1_1);
