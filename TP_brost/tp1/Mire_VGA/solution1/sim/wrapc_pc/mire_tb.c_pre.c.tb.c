...
// ==============================================================
# 1 "C:/Users/ai770741/Documents/TP_Brost/tp1/Mire_VGA/src/mire_tb.c"
# 1 "C:/Users/ai770741/Documents/TP_Brost/tp1/Mire_VGA/src/mire_tb.c" 1
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 147 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "C:/Users/ai770741/Documents/TP_Brost/tp1/Mire_VGA/src/mire_tb.c" 2
...
# 2 "C:/Users/ai770741/Documents/TP_Brost/tp1/Mire_VGA/src/mire_tb.c" 2
struct pixel {
 unsigned char red;
 unsigned char green;
 unsigned char blue; };
...
#ifndef HLS_FASTSIM
#ifndef HLS_FASTSIM
#include "apatb_mire.h"
#endif
# 8 "C:/Users/ai770741/Documents/TP_Brost/tp1/Mire_VGA/src/mire_tb.c"
int main() {
 struct pixel p[640*480];
 FILE *file_out;
 
#ifndef HLS_FASTSIM
#define mire AESL_WRAP_mire
#endif
# 11 "C:/Users/ai770741/Documents/TP_Brost/tp1/Mire_VGA/src/mire_tb.c"
mire(p);
#undef mire
# 11 "C:/Users/ai770741/Documents/TP_Brost/tp1/Mire_VGA/src/mire_tb.c"

 int x,y;
 file_out=fopen("test3.ppm","w");
 fprintf(file_out,"P3\n");
 fprintf(file_out,"640 480\n");
 fprintf(file_out,"255\n");
for (y=0;y<480;y++) {
 for (x=0;x<640;x++)
  fprintf(file_out,"%d %d %d ",p[y*640+x].red,p[y*640+x].green,p[y*640+x].blue);
  fprintf(file_out,"\n");
  }
fclose(file_out); }
#endif
# 22 "C:/Users/ai770741/Documents/TP_Brost/tp1/Mire_VGA/src/mire_tb.c"
