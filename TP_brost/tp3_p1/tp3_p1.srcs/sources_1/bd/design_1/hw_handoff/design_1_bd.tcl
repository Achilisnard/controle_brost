...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net xlconstant_2_dout [get_bd_pins c_grav_0/ap_rst_n] [get_bd_pins c_grav_0/ap_start] [get_bd_pins c_grav_0/cg_on_V] [get_bd_pins im_load_0/ap_rst_n] [get_bd_pins im_load_0/ap_start] [get_bd_pins xlconstant_2/dout]
  connect_bd_net -net xlconstant_3_dout [get_bd_pins c_grav_0/vsize_in] [get_bd_pins xlconstant_3/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins c_grav_0/hsize_in] [get_bd_pins xlconstant_4/dout]
