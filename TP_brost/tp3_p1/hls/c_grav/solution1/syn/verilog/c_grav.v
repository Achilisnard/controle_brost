...
(* CORE_GENERATION_INFO="c_grav,hls_ip_2019_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020-clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.510000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=150,HLS_SYN_LUT=200,HLS_VERSION=2019_2}" *)
...
reg   [0:0] icmp_ln15_reg_190_pp0_iter1_reg;
reg   [63:0] indvar_flatten_reg_121;
wire   [63:0] bound_fu_140_p2;
reg   [63:0] bound_reg_185;
...
wire   [63:0] add_ln15_fu_151_p2;
reg   [7:0] tmp_data_V_reg_199;
reg   [0:0] tmp_keep_V_reg_204;
reg   [0:0] tmp_strb_V_reg_209;
reg   [0:0] tmp_user_V_reg_214;
reg   [0:0] tmp_last_V_reg_219;
reg   [0:0] tmp_id_V_reg_224;
reg   [0:0] tmp_dest_V_reg_229;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state2;
reg    ap_block_pp0_stage0_01001;
wire   [31:0] bound_fu_140_p0;
wire   [31:0] bound_fu_140_p1;
...
wire   [63:0] bound_fu_140_p00;
wire   [63:0] bound_fu_140_p10;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln15_fu_146_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((icmp_ln15_fu_146_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if ((icmp_ln15_fu_146_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((((icmp_ln15_reg_190_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((icmp_ln15_reg_190 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0)))) begin
...
always @ (*) begin
    if (((icmp_ln15_reg_190 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((icmp_ln15_fu_146_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter1 == 1'b0) & (icmp_ln15_fu_146_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)) & ~((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)) | ((ap_enable_reg_pp0_iter1 == 1'b0) & (icmp_ln15_fu_146_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone)))) begin
...
assign add_ln15_fu_151_p2 = (indvar_flatten_reg_121 + 64'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((icmp_ln15_fu_146_p2 == 1'd0) & (s_axis_video_TVALID_int == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln15_fu_146_p2 == 1'd0) & (s_axis_video_TVALID_int == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((1'b1 == ap_block_state4_io) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((1'b1 == ap_block_state3_io) & (ap_enable_reg_pp0_iter1 == 1'b1)) | ((icmp_ln15_fu_146_p2 == 1'd0) & (s_axis_video_TVALID_int == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter0 = ((icmp_ln15_fu_146_p2 == 1'd0) & (s_axis_video_TVALID_int == 1'b0));
end

always @ (*) begin
    ap_block_state3_io = ((icmp_ln15_reg_190 == 1'd0) & (m_axis_video_TREADY_int == 1'b0));
end

assign ap_block_state3_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state4_io = ((icmp_ln15_reg_190_pp0_iter1_reg == 1'd0) & (m_axis_video_TREADY_int == 1'b0));
end
...
assign bound_fu_140_p0 = bound_fu_140_p00;

assign bound_fu_140_p00 = hsize_in;

assign bound_fu_140_p1 = bound_fu_140_p10;

assign bound_fu_140_p10 = vsize_in;

assign bound_fu_140_p2 = (bound_fu_140_p0 * bound_fu_140_p1);

assign icmp_ln15_fu_146_p2 = ((indvar_flatten_reg_121 == bound_reg_185) ? 1'b1 : 1'b0);
