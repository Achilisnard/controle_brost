...
void c_grav(AXI_STREAM_RGB& s_axis_video, AXI_STREAM_RGB& m_axis_video, int hsize_in, int vsize_in);
int main (int argc, char** argv) {
    // Load data in OpenCV image format
    IplImage* src = cvLoadImage("..\\..\\..\\circle.png", CV_LOAD_IMAGE_COLOR);
    ...
    AXI_STREAM_RGB src_axi, dst_axi, dst_axi2;
